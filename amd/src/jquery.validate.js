/*
 * @package    theme_campusbcp
 * @copyright  2017 PVirtual
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * @module theme_campusbcp/jquery.validate
 * Se encuentra adaptado usando los metodos de es_CL
 */
...
// http://jqueryvalidation.org/jQuery.validator.format/
    ...
    $.extend($.validator, {
        ...
        defaults: {
            ...
            pendingClass: "form-control-warning",
            validClass: "form-control-success",
            errorElement: "div",
            errorLabelClass: "form-control-feedback",
            focusCleanup: false,
            focusInvalid: true,
            errorContainer: $([]),
            errorLabelContainer: $([]),
        ...
        prototype: {
            ...
            errors: function () {
                var errorClass = this.settings.errorLabelClass.split(" ").join(".");
        ...
        methods: {
            ...
            date: function (value, element) {
                return this.optional(element) || /^\d\d?\-\d\d?\-\d\d\d?\d?$/.test(value) || /^\d\d\d\d\-\d\d?\-\d\d?$/.test(value);
            },
